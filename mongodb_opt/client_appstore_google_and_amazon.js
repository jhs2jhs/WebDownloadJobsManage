...
mylib_client.myjobs_init(myjobs, 'appid_asin_pairs', function(){main()});
...
//
function main(){
	mylib_util.folder_init(myjobs.myenv['data_row_path'], myjobs.jobs_target+'-asin');
	mylib_util.folder_init(myjobs.myenv['data_row_path'], myjobs.jobs_target+'-appid');
...
function jobs_do_download(job){
	...
	//var job_file_path = '../../'+myjobs.myenv['data_row_path']+job.job_file_path.replace('/web_jobs', '');
	var job_file_path = '../../'+myjobs.myenv['data_row_path']+job.job_file_path;
	ttttt = ttttt + 1;
	job.job_file_path = job_file_path;
	console.log(job.job_url, job.job_file_path);
